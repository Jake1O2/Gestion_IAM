		...
		<div id="content" class="content">
					...
					<div class="panel panel-inverse">
						<div class="panel-heading">
							...
							<div class="panel-heading-btn">
								...
								<form method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir réinitialiser toutes les données ?');">
									<input type="hidden" name="action" value="reset_session" />
									<button type="submit" class="btn btn-xs btn-warning"><i class="fa fa-refresh"></i> Réinitialiser</button>
								</form>
							</div>
						</div>
			...
			<div class="row">
											...
											<form action="gestion_iam.php" method="POST">
												...
												<div class="form-group">
													...
													<?php if ($role === 'Administrateur'): ?>
														...
														<label for="p_admin_3">Lire les journaux de sécurité</label>
														</div>
				...
				<div class="col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
									<h4 class="panel-title">Audit Trail / Logs d'accès</h4>
						</div>
						<div class="panel-body">
